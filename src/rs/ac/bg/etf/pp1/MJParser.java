...
/** CUP v0.10k generated parser.
  * @version Sun Oct 05 17:42:57 CEST 2025
  */
      ...
      switch (CUP$MJParser$act_num)
		...
		FormParsList F2 = (FormParsList)((java_cup.runtime.Symbol) CUP$MJParser$stack.elementAt(CUP$MJParser$top-1)).value;
		 RESULT=new MethodSignature(M1, methName, F2); RESULT.setLine(M1left); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 21: // RemainingVarsList ::= 
            {
              RemainingVarsList RESULT = null;
		 RESULT=new NoRemainingVars(); 
              CUP$MJParser$result = new java_cup.runtime.Symbol(7/*RemainingVarsList*/, ((java_cup.runtime.Symbol)CUP$MJParser$stack.elementAt(CUP$MJParser$top-0)).right, ((java_cup.runtime.Symbol)CUP$MJParser$stack.elementAt(CUP$MJParser$top-0)).right, RESULT);
            }
          return CUP$MJParser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 20: // RemainingVarsList ::= RemainingVarsList COMMA IDENT BracketsList 
            {
              RemainingVarsList RESULT = null;
		...
		RemainingVarsList R1 = (RemainingVarsList)((java_cup.runtime.Symbol) CUP$MJParser$stack.elementAt(CUP$MJParser$top-3)).value;
		int remainingVarleft = ((java_cup.runtime.Symbol)CUP$MJParser$stack.elementAt(CUP$MJParser$top-1)).left;
		int remainingVarright = ((java_cup.runtime.Symbol)CUP$MJParser$stack.elementAt(CUP$MJParser$top-1)).right;
		String remainingVar = (String)((java_cup.runtime.Symbol) CUP$MJParser$stack.elementAt(CUP$MJParser$top-1)).value;
		...
		BracketsList B2 = (BracketsList)((java_cup.runtime.Symbol) CUP$MJParser$stack.elementAt(CUP$MJParser$top-0)).value;
		 RESULT=new RemainingVars(R1, remainingVar, B2); RESULT.setLine(R1left); 
              CUP$MJParser$result = new java_cup.runtime.Symbol(7/*RemainingVarsList*/, ((java_cup.runtime.Symbol)CUP$MJParser$stack.elementAt(CUP$MJParser$top-3)).left, ((java_cup.runtime.Symbol)CUP$MJParser$stack.elementAt(CUP$MJParser$top-0)).right, RESULT);
            }
          return CUP$MJParser$result;
		...
		BracketsList B1 = (BracketsList)((java_cup.runtime.Symbol) CUP$MJParser$stack.elementAt(CUP$MJParser$top-0)).value;
		 RESULT=new FirstVar(varType, varName, B1); RESULT.setLine(varTypeleft); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 16: // VarDecl ::= FirstVar RemainingVarsList SEMI 
            {
              VarDecl RESULT = null;
		...
		int R1left = ((java_cup.runtime.Symbol)CUP$MJParser$stack.elementAt(CUP$MJParser$top-1)).left;
		int R1right = ((java_cup.runtime.Symbol)CUP$MJParser$stack.elementAt(CUP$MJParser$top-1)).right;
		RemainingVarsList R1 = (RemainingVarsList)((java_cup.runtime.Symbol) CUP$MJParser$stack.elementAt(CUP$MJParser$top-1)).value;
		 RESULT=new VarDecl(first, R1); RESULT.setLine(firstleft); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 15: // RemainingConstsList ::= 
            {
              RemainingConstsList RESULT = null;
		 RESULT=new NoRemainingConsts(); 
              CUP$MJParser$result = new java_cup.runtime.Symbol(4/*RemainingConstsList*/, ((java_cup.runtime.Symbol)CUP$MJParser$stack.elementAt(CUP$MJParser$top-0)).right, ((java_cup.runtime.Symbol)CUP$MJParser$stack.elementAt(CUP$MJParser$top-0)).right, RESULT);
            }
          return CUP$MJParser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 14: // RemainingConstsList ::= RemainingConstsList COMMA IDENT EQUAL_SIGN ConstValueList 
            {
              RemainingConstsList RESULT = null;
		...
		RemainingConstsList R1 = (RemainingConstsList)((java_cup.runtime.Symbol) CUP$MJParser$stack.elementAt(CUP$MJParser$top-4)).value;
		...
		ConstValueList C2 = (ConstValueList)((java_cup.runtime.Symbol) CUP$MJParser$stack.elementAt(CUP$MJParser$top-0)).value;
		 RESULT=new RemainingConsts(R1, constName, C2); RESULT.setLine(R1left); 
              CUP$MJParser$result = new java_cup.runtime.Symbol(4/*RemainingConstsList*/, ((java_cup.runtime.Symbol)CUP$MJParser$stack.elementAt(CUP$MJParser$top-4)).left, ((java_cup.runtime.Symbol)CUP$MJParser$stack.elementAt(CUP$MJParser$top-0)).right, RESULT);
            }
          return CUP$MJParser$result;
		...
		ConstValueList constValue = (ConstValueList)((java_cup.runtime.Symbol) CUP$MJParser$stack.elementAt(CUP$MJParser$top-0)).value;
		 RESULT=new FirstConst(constType, constName, constValue); RESULT.setLine(constTypeleft); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 8: // ConstDecl ::= FirstConst RemainingConstsList SEMI 
            {
		...
		int R1left = ((java_cup.runtime.Symbol)CUP$MJParser$stack.elementAt(CUP$MJParser$top-1)).left;
		int R1right = ((java_cup.runtime.Symbol)CUP$MJParser$stack.elementAt(CUP$MJParser$top-1)).right;
		RemainingConstsList R1 = (RemainingConstsList)((java_cup.runtime.Symbol) CUP$MJParser$stack.elementAt(CUP$MJParser$top-1)).value;
		 RESULT=new ConstDecl(first, R1); RESULT.setLine(firstleft); 
