...
public class FactorDesignatorFunc extends Factor {

    private Designator Designator;
    private ActualPars ActualPars;

    public FactorDesignatorFunc (Designator Designator, ActualPars ActualPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FactorDesignatorFunc(\n");
